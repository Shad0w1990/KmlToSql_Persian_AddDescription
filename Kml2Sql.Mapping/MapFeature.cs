...
namespace Kml2Sql.Mapping
{
    ...
    public class MapFeature
    {
        ...
        public string Description => Placemark?.Description.Text;
        /// <summary>
        ...
        private void InitializeData(Placemark placemark)
        {
            foreach (SimpleData sd in placemark.Flatten().OfType<SimpleData>())
            {
                ...
                if (sd.Name.ToLower() == "description")
                {
                    sd.Name = "placemark_sd_description";
                }
            ...
            foreach (Data data in placemark.Flatten().OfType<Data>())
            {
                ...
                if (data.Name.ToLower() == "description")
                {
                    data.Name = "placemark_data_description";
                }
